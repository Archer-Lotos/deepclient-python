...
class DeepClient:
    ...
    def __init__(self, options: Optional[DeepClientOptions] = None):
        self.files_select_returning = None
        self.selectors_select_returning = None
        self.values_select_returning = None
        self.links_select_returning = None
        self.table = None
        self.default_select_name = None
